                ...
                <div className="flex flex-col items-center justify-center h-full px-4 text-center z-10 relative lg:mt-[-5vh]">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-4xl">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => setInput("Tell me about ")}
                    ...
                    >
                      ...
                      <h3 className="text-white font-bold mb-1">Knowledge</h3>
                      <p className="text-xs text-gray-400">Wikipedia & AI Memory</p>
                    </motion.button>
